...
async function CountLessThan(delay = showVal()) {
  ...
  codeExplaination.replaceChildren();
  codeExplaination.innerHTML += `end Traversal`;
  ...
  codeExplaination.replaceChildren();
  codeExplaination.innerHTML += `return total number of values less than ${conditionValue.value}`;
  document.getElementById("setCountValue6").style.backgroundColor = "#13CE66";
...
async function CountGreaterThan(delay = showVal()) {
  ...
  for (var i = 0; i < blocks.length; i += 1) {
    ...
    if (currentArray[i] > Number(ConditionsValuesInput.value)) {
      ...
      document.getElementById("setCountValue4").style.backgroundColor =
        "#13CE66";
      codeExplaination.replaceChildren();
      codeExplaination.innerHTML += `Greater number is added to count`;
  ...
  document.getElementById("setCountValue5").style.backgroundColor = "white";
  codeExplaination.replaceChildren();
  codeExplaination.innerHTML += `return total number of values greater than ${ConditionsValuesInput.value}`;
  document.getElementById("setCountValue6").style.backgroundColor = "#13CE66";
  //enabling the buttons once operation is complete
  enableCounting();
}
  ...
  for (var i = 0; i < blocks.length; i += 1) {
    ...
    if (currentArray[i] % 2 != 0) {
      ...
      codeExplaination.innerHTML +=
        "if the current value is NOT divisible by 2, then";
      header.innerText = `The new sum of odd numbers is: ${count}`;
      ...
      document.getElementById("setCountValue4").style.backgroundColor =
        "#13CE66";
      codeExplaination.replaceChildren();
      codeExplaination.innerHTML += `Odd number is added to sum`;

      // adding the number of even number with each iteration
      count++;
      header.innerText = `The total number of Odd Numbers is: ${count}`;
...
async function CountEvenNumber(delay = showVal()) {
  ...
  for (var i = 0; i < blocks.length; i += 1) {
    ...
    if (currentArray[i] % 2 == 0) {
      ...
      header.innerText = `The new sum of even numbers is: ${count}`;
...
async function maximum(delay = showVal()) {
  ...
  // setting each algorithm line to a list item in the index.html file
  setCountValue.innerHTML += `
  <li id='setCountValue1'  class = 'listCss'>${maximumPsuedo[0]}</li>
  <li id='setCountValue2' class = 'listCss'>${maximumPsuedo[1]}</li>
  <li id='setCountValue3'  class = 'listCss'>${maximumPsuedo[2]}</li>
  <li id='setCountValue4'  class = 'listCss'>${maximumPsuedo[3]}</li>
  <li id='setCountValue5'  class = 'listCss'>${maximumPsuedo[4]}</li>
  <li id='setCountValue6'  class = 'listCss'>${maximumPsuedo[5]}</li>
  <li id='setCountValue7'  class = 'listCss'>${maximumPsuedo[6]}</li>`;
  header.replaceChildren();
  ...
  for (var i = 1; i < blocks.length; i += 1) {
    blocks[i].style.backgroundColor = "#FF4949";
    codeExplaination.replaceChildren();
    codeExplaination.innerHTML += `Traversing through array to find values greater than ${max} number`;
    document.getElementById("setCountValue1").style.backgroundColor = "white";
    document.getElementById("setCountValue2").style.backgroundColor = "#FF4949";
    ...
    if (max < cuurentValue) {
      ...
      codeExplaination.innerHTML +=
        "if the current value is greater than the current max value, then";
      await new Promise((resolve) =>
        setTimeout(() => {
          resolve();
        }, 2000)
  ...
  document.getElementById("setCountValue7").style.backgroundColor = "#13CE66";
}
...
async function minimum(delay = showVal()) {
  ...
  for (var i = 1; i < blocks.length; i += 1) {
    ...
    blocks[i].style.backgroundColor = "#FF4949";
    codeExplaination.replaceChildren();
    codeExplaination.innerHTML += `Traversing through array to find values less than ${min} number`;
    document.getElementById("setCountValue1").style.backgroundColor = "white";
    document.getElementById("setCountValue2").style.backgroundColor = "#FF4949";
    // To wait for .5 sec
    await new Promise((resolve) =>
    ...
    if (min > cuurentValue) {
      ...
      codeExplaination.innerHTML +=
        "if the current value is less than the current Min value, then";
      await new Promise((resolve) =>
        setTimeout(() => {
          resolve();
        }, 2000)
      ...
      header.innerText = `The new minimum value is: ${min} at index ${index}`;
      blocks[index].style.backgroundColor = "#13CE66";
    }
    document.getElementById("setCountValue4").style.backgroundColor = "white";
